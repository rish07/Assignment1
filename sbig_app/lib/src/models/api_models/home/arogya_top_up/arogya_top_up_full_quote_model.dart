...
class ArogyaTopUpFullQuoteReqModel {
  ...
  ArogyaTopUpFullQuoteReqModel.fromJson(Map<String, dynamic> json) {
...
class ArogyaTopUpFullQuoteResModel {
  bool success;
  String message;
  Data data;
  ApiErrorModel apiErrorModel;

  ArogyaTopUpFullQuoteResModel({this.success, this.message, this.data});

  ArogyaTopUpFullQuoteResModel.fromJson(Map<String, dynamic> json) {
