...
class ArogyaTopUpIndividualMemberDetailsScreen extends StatelessWidget {
  static const ROUTE_NAME = "/arogya_top_up/arogya_inusree_member_details_screen";

  final ArogyaTopUpModel arogyaTopUpModel;

  ArogyaTopUpIndividualMemberDetailsScreen(this.arogyaTopUpModel);

  @override
  Widget build(BuildContext context) {
    return SbiBlocProvider(
      child: InsureMemberDetailsScreenWidget(arogyaTopUpModel),
...
class InsureMemberDetailsScreenWidget extends StatefulWidget {
  ...
  InsureMemberDetailsScreenWidget(this.arogyaTopUpModel);
...
class _InsureMemberDetailsScreenState
  ...
  void initState() {
    ...
    if(policyMembers.length == 1){
      memberDetailsModel = widget.arogyaTopUpModel.policyMembers[0].memberDetailsModel;
    }
                  ...
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                          firstNameError,
                          style: TextStyle(color: ColorConstants.error_red, fontSize: 12),
                        ),
                      )
                    ],
                  );
                ...
                if (null == memberDetailsModel.ageGenderModel.dob) {
                  ...
                  Future.delayed(Duration(milliseconds: 200), () {
                    if (errorText == null) {
                      ...
                      widget.arogyaTopUpModel.policyMembers[0].memberDetailsModel= memberDetailsModel;
                      Navigator.of(context).pushNamed(
                          ArogyaTopUpInsureDetailsScreen.ROUTE_NAME,
