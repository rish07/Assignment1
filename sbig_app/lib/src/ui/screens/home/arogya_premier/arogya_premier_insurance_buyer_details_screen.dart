...
import 'arogya_premier_eia_screen.dart';

class ArogyaPremierInsuranceBuyerDetailsScreen extends StatelessWidget {
  static const double EXTRA_SPACE = 100;
  static const ROUTE_NAME = "/arogya/insurance_buyer_details_screen";
  ...
  ArogyaPremierInsuranceBuyerDetailsScreen(this.arogyaPremierModel);

  @override
  Widget build(BuildContext context) {
    return SbiBlocProvider(
      child: InsuranceBuyerDetails(arogyaPremierModel),
...
class InsuranceBuyerDetails extends StatefulWidgetBase {
  ...
  InsuranceBuyerDetails(this.arogyaPremierModel);
...
//    }
    ...
    if (null != widget.arogyaPremierModel.isProposerSelf) {
      if (widget.arogyaPremierModel.isProposerSelf) {
        widget.arogyaPremierModel.policyMembers.forEach((member) {
    ...
    pages = [
      ...
      quickFact: StringDescription.quick_fact19,
      ),
    ...
    quickFact: StringDescription.quick_fact25,),
  ...
  void didChangeDependencies() {
    try {
      quoteNumber = S
          ...
          .quote_number
          .toUpperCase() + ": ";
      if (null != widget.arogyaPremierModel.quoteNumber) {
        quoteNumber = quoteNumber + widget.arogyaPremierModel.quoteNumber;
      }

      int redirection = prefsHelper.getRedirection();
      if (redirection != null) {
        if (redirection ==
            ArogyaPremierInsuranceBuyerDetailsScreen.COMMUNICATION_DETAILS_WIDGET) {
...
//        });
          _pageController.animateToPage(_currentIndex = 1,
            ...
            ArogyaPremierInsuranceBuyerDetailsScreen.NOMINEE_DETAILS_WIDGET) {
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          ScreenUtil.getInstance(context).screenHeightDp +
                              ArogyaPremierInsuranceBuyerDetailsScreen.EXTRA_SPACE,
                          width: double.maxFinite,
                          child: PageView(
...
//                          ),
  ...
  childWidgetListener(
    ...
    switch (from) {
      case ArogyaPremierInsuranceBuyerDetailsScreen.PROPOSER_DETAILS_WIDGET:
      //_swiperController.move(_currentIndex = 0, animation: true);
        _pageController.animateToPage(_currentIndex = 0,
            duration: Duration(milliseconds: 500), curve: Curves.decelerate);
        break;
      case ArogyaPremierInsuranceBuyerDetailsScreen.COMMUNICATION_DETAILS_WIDGET:
        ...
        _pageController.animateToPage(
            ...
            curve: Curves.decelerate);
        break;
      case ArogyaPremierInsuranceBuyerDetailsScreen.NOMINEE_DETAILS_WIDGET:
        ...
        _pageController.animateToPage(
            ...
            curve: Curves.decelerate);
        break;
      case ArogyaPremierInsuranceBuyerDetailsScreen.APPOINTEE_DETAILS_WIDGET:
        ...
        if (dob != null) {
          ...
          if (duration.inDays > 0) {
            ...
            updateData(false);
            Navigator.of(context).pushNamed(ArogyaPremierEIANumberScreen.ROUTE_NAME,
                arguments: widget.arogyaPremierModel);
          }
        }
        break;
      case ArogyaPremierInsuranceBuyerDetailsScreen.TO_POLICY_SUMMERY_SCREEN:
        appointeeDetailsModel = object;
        updateData(true);
        Navigator.of(context).pushNamed(ArogyaPremierEIANumberScreen.ROUTE_NAME,
            arguments: widget.arogyaPremierModel);
  ...
  updateData(bool isNomineeMinor) {
    ...
    widget.arogyaPremierModel.buyerDetails = buyerDetails;
  }
  ...
  Widget _showNextButton() {
    onClick() {
      switch (_pageCount == 4 ? _currentIndex : _currentIndex + 1) {
        case 0:
          _bloc.proposerDetailsWidgetSC.sink.add(ArogyaPremierInsuranceBuyerDetailsScreen.PROPOSER_DETAILS_WIDGET);
          break;
        case 1:
          _bloc.communicationWidgetSC.sink.add(ArogyaPremierInsuranceBuyerDetailsScreen.COMMUNICATION_DETAILS_WIDGET);
          break;
        case 2:
          _bloc.nominieeDetailsWidgetSC.sink.add(ArogyaPremierInsuranceBuyerDetailsScreen.NOMINEE_DETAILS_WIDGET);
          break;
        case 3:
          _bloc.appointeeDetailsWidgetSC.sink.add(ArogyaPremierInsuranceBuyerDetailsScreen.APPOINTEE_DETAILS_WIDGET);
          break;
      }
    }
