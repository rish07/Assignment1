...
import 'arogya_premier_premium_breakup_screen.dart';

class ArogyaTimePeriodScreen extends StatefulWidgetBase {
  static const ROUTE_NAME = "/arogya/time_period_screen";

  final  ArogyaPremierModel arogyaPremierModel;

  ArogyaTimePeriodScreen(this.arogyaPremierModel);

  @override
  _TimePeriodScreenState createState() => _TimePeriodScreenState();
}

class _TimePeriodScreenState extends State<ArogyaTimePeriodScreen>
    with CommonWidget {
  ...
  void didChangeDependencies() {
    ArogyaSumInsuredModel sumInsuredModel = widget.arogyaPremierModel.selectedSumInsured;
    var timePeriod = widget.arogyaPremierModel.selectedSumInsured.timePeriod;
    _timePeriodList = [];
...
//                    _selectedTimePeriod = index;
  ...
  onClick(int index) {
    setState(() {
      _selectedTimePeriod = index;
       widget.arogyaPremierModel.selectedTimePeriodModel = _timePeriodList[_selectedTimePeriod];
      Navigator.of(context).pushNamed(ArogyaPremierPremiumBreakupScreen.ROUTE_NAME,
