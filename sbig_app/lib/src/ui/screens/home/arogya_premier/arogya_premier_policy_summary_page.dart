...
class ArogyaPremierPolicySummeryScreen extends StatefulWidgetBase {
  static const ROUTE_NAME = "/arogya_premier/policy_summery_screen";

  final ArogyaPremierModel arogyaPremierModel;

  ArogyaPremierPolicySummeryScreen(this.arogyaPremierModel);

  @override
  _PolicySummeryScreenState createState() => _PolicySummeryScreenState();
}

class _PolicySummeryScreenState extends State<ArogyaPremierPolicySummeryScreen>
    with CommonWidget {
  ...
  ArogyaPremierPaymentController _paymentController;
  ...
  void initState() {
    try {
      ...
      nomineeDetailsModel =
          widget.arogyaPremierModel.buyerDetails.nomineeDetailsModel;
      communicationDetailsModel =
          widget.arogyaPremierModel.buyerDetails.communicationDetailsModel;
      proposerDetails = widget.arogyaPremierModel.buyerDetails.proposerDetails;
      personalDetails = widget.arogyaPremierModel.personalDetails;
      policyMembers = widget.arogyaPremierModel.policyMembers;
      sumInsuredModel = widget.arogyaPremierModel.selectedSumInsured;
      policyPeriod = widget.arogyaPremierModel.policyPeriod;
      ...
      phone = widget.arogyaPremierModel.personalDetails.mobile;
      email = widget.arogyaPremierModel.personalDetails.email;
    } catch (e) {
...
//  }
  ...
  _showButton() {
    onProceedBuy() {
      try {
        ...
        ArogyaPremierQuickQuoteReqModel quickQuoteReqModele =
            widget.arogyaPremierModel.arogyaPremierQuickQuoteReqModel;
        ArogyaPremierQuickQuoteResModel quickQuoteResModel =
            widget.arogyaPremierModel.arogyaPremierQuickQuoteResModel;

        BuyerDetails buyerDetails = widget.arogyaPremierModel.buyerDetails;
        NomineeDetailsModel nomineeDetailsModel =
        ...
        arogyaPremierFullQuoteReqModel.arogyaPolicyType =
            StringConstants.AROGYA_PREMIER;
        arogyaPremierFullQuoteReqModel.effectiveDate =
            quickQuoteReqModele.effectiveDate;
        arogyaPremierFullQuoteReqModel.expiryDate =
            quickQuoteReqModele.expiryDate;
        arogyaPremierFullQuoteReqModel.customerName =
            proposerDetails.firstName + ' ' + proposerDetails.lastName;
        arogyaPremierFullQuoteReqModel.firstName = proposerDetails.firstName;
        arogyaPremierFullQuoteReqModel.middleName = '';
        arogyaPremierFullQuoteReqModel.lastName = proposerDetails.lastName;
        arogyaPremierFullQuoteReqModel.genderCode = proposerDetails.gender;
        arogyaPremierFullQuoteReqModel.dateOfBirth =
            proposerDetails.dobFormat.dob_yyyy_mm_dd;
        arogyaPremierFullQuoteReqModel.buildingHouseName =
            communicationDetailsModel.buildingName;
        arogyaPremierFullQuoteReqModel.streetName =
            communicationDetailsModel.streetName;
        arogyaPremierFullQuoteReqModel.postCode =
            communicationDetailsModel.pinCode;
        arogyaPremierFullQuoteReqModel.city = pinCodeData.CITY_NM;
        arogyaPremierFullQuoteReqModel.state = pinCodeData.STATE_CD;
        arogyaPremierFullQuoteReqModel.mobile = quickQuoteReqModele.mobile;
        arogyaPremierFullQuoteReqModel.email = quickQuoteReqModele.email;
        arogyaPremierFullQuoteReqModel.plotNo = communicationDetailsModel.plotNo;
        arogyaPremierFullQuoteReqModel.eIANumber = widget.arogyaPremierModel.eiaModel.eiaNumber;
        arogyaPremierFullQuoteReqModel.duration = quickQuoteReqModele.policyDuration;
        arogyaPremierFullQuoteReqModel.policyType = quickQuoteReqModele.policyType;
        arogyaPremierFullQuoteReqModel.agentCode=proposerDetails.agentCode??'';
        ...
        arogyaPremierFullQuoteReqModel.policyRiskList=list;

        showLoaderDialog(context);
        FullQuoteApiProvider.getInstance()
            .calculateArogyaPremierFullQuote(
                arogyaPremierFullQuoteReqModel.toJson())
            .then((response) {
          if (null == response.apiErrorModel) {

            widget.arogyaPremierModel.arogyaPremierFullQuoteResModel = response;
            widget.arogyaPremierModel.quoteNumber =
            ...
            if (_isOtpVerifiedSC.value) {
              ...
              _makeOTPApiCall(widget.arogyaPremierModel.personalDetails.mobile,
                  widget.arogyaPremierModel.quoteNumber ?? '', null);
            }
          } else {
            hideLoaderDialog(context);
  ...
  void _initiatePayment() {
    ...
    _paymentController = ArogyaPremierPaymentController(
