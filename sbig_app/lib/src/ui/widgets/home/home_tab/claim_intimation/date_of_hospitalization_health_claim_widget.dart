...
class DateOfHospitalizationHealthClaimWidget extends StatelessWidget {
  ...
  DateOfHospitalizationHealthClaimWidget(this.bloc, this.onDateSelection,
      {this.age,
      this.dob,
      this.height = 35.0,
      this.outlineColor,
          ...
          children: <Widget>[
            ...
            Expanded(
              child: StreamBuilder<String>(
                  stream: bloc.dateOfHospitalizationStream,
  ...
  _showDatePicker(BuildContext context, HealthClaimBloc bloc) async {
    ...
    if (bloc.dateOfHospitalization != null &&
        bloc.dateOfHospitalization.isNotEmpty) {
      dob = bloc.dateOfHospitalization;
