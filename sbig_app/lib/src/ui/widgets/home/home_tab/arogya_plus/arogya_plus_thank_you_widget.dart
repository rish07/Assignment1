...
import 'package:sbig_app/src/controllers/blocs/home/arogya_plus/mics/arogya_thank_you_widget_bloc.dart';
...
class ArogyaPlusThankYouWidget extends StatelessWidget {
  final Function(int) onClick;
  final List<MapModel> list;
  final String policyId;
  final String description;
  ArogyaPlusThankYouWidget(this.onClick, this.list, this.policyId, this.description);

  @override
  Widget build(BuildContext context) {
    return SbiBlocProvider(
      bloc: ArogyaThankYouWidgetBloc(),
      child: _ArogyaPlusThankYouWidgetInternal(onClick, list, policyId, description),
    );
  }

}
class _ArogyaPlusThankYouWidgetInternal extends StatefulWidget {

  final Function(int) onClick;
  final List<MapModel> list;
  final String policyId;
  final String description;
  _ArogyaPlusThankYouWidgetInternal(this.onClick, this.list, this.policyId, this.description);

  @override
  __ArogyaPlusThankYouWidgetInternalState createState() => __ArogyaPlusThankYouWidgetInternalState();
}

class __ArogyaPlusThankYouWidgetInternalState extends State<_ArogyaPlusThankYouWidgetInternal> with CommonWidget {
  ArogyaThankYouWidgetBloc _bloc;
  ...
  @override
  void initState() {
    _bloc = SbiBlocProvider.of<ArogyaThankYouWidgetBloc>(context);
    ...
    _bloc.uiEventStream.listen((e) {
      if(e is DownloadCompleteEvent) {
       ...
       /* if(event.dialogType == DialogEvent.DIALOG_TYPE_NETWORK_ERROR) {
          showNoInternetDialog(context, _currentApiCall, (retryId) {
            switch(retryId) {
              case ApiCallIdentifier.HEALTH_CARD:
                _executeHealthCardDownloadApi();
                break;
          ...
          showServerErrorDialog(context, _currentApiCall, (retryId) {
            switch(retryId) {
              case ApiCallIdentifier.HEALTH_CARD:
                _executeHealthCardDownloadApi();
                break;
            ...
            SnackBar(
              ...
              action: SnackBarAction(
                label: S
                    .of(context)
                    .open.toUpperCase(),
                textColor: ColorConstants.pre_medical_gradient_color1,
                onPressed: () {
                        ...
                        children: <Widget>[
                          ...
                          Visibility(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                _bottomButtons(context, S.of(context).health_card, () {
                                  _executeHealthCardDownloadApi();
                                }),
                                SizedBox(height: 10,),
    ...
    return InkResponse(
      ...
      child: Container(
        decoration: BoxDecoration(
            ...
            border: Border.all(color: ColorConstants.policy_type_gradient_color2)
        ),
        child: Container(
...
//  void checkStoragePermission(Function taskToExecuteIfGranted, GlobalKey<ScaffoldState> _scaffoldKey) {
