...
class ArogyaMemberDetailsBottomSheetWidget {
  ...
  ArogyaMemberDetailsBottomSheetWidget(this.memberDetailsModel, this.onUpdate,
  ...
  void showBottomSheet(context) {
    ...
    onClickUpdateDetails() {
      onUpdate(
          ArogyaMemberDetailsBottomSheetWidget.age,
          ArogyaMemberDetailsBottomSheetWidget.gender,
          selectedMember,
          false);
      ArogyaMemberDetailsBottomSheetWidget.age = null;
      ArogyaMemberDetailsBottomSheetWidget.gender = null;
...
class _GenderListWidgetState extends State<GenderListWidget> {
  ...
  _buildGenderItems() {
    ...
    if (isHavingDefaultGender) {
      ...
      !TextUtils.isEmpty(ArogyaMemberDetailsBottomSheetWidget.gender);
      bool isMale = !isGenderSelected
          ? false
          : (ArogyaMemberDetailsBottomSheetWidget.gender.compareTo("M") ==
          0);
...
//                widget.memberDetailsModel.ageGenderModel.gender = "M";
                ArogyaMemberDetailsBottomSheetWidget.gender = "M";
                if (ArogyaMemberDetailsBottomSheetWidget.age != null && !widget.isUpdateVisible) {
...
//                widget.memberDetailsModel.ageGenderModel.gender = "F";
                ArogyaMemberDetailsBottomSheetWidget.gender = "F";
//                widget.onUpdate(
...
class _AgeWidgetState extends State<AgeWidget> {
  ...
  @override
  void initState() {
    int age = ArogyaMemberDetailsBottomSheetWidget.age ;
    String year = "years";
    if (age == 1) {
      year = "year";
    }
        ...
        child: DropdownButton<String>(
          ...
          onChanged: (String newValue) {
            setState(() {
              ...
              ArogyaMemberDetailsBottomSheetWidget.age = age;

              if (ArogyaMemberDetailsBottomSheetWidget.gender != null && !widget.isUpdateVisible) {
                Future.delayed(Duration(milliseconds: 500), () {
                  widget.onUpdate(
                      ArogyaMemberDetailsBottomSheetWidget.age,
                      ArogyaMemberDetailsBottomSheetWidget.gender,
