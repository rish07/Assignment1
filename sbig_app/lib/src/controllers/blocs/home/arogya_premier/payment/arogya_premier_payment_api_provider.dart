...
class ArogyaPremierPaymentApiProvider extends ApiResponseListenerDio {
  Future<ParsedResponse<InsurancePaymentResModel>> paymentStatusCheckApiCall(InsurancePayment request) async {
    return BaseApiProvider.postApiCall(UrlConstants.PAYMENT_PROCESS_AROGYA_PREMIER_URL, request.toJson()).then((response) {
      try {
