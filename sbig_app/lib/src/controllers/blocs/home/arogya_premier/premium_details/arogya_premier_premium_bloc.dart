...
import 'arogya_premier_premium_api_provider.dart';

class ArogyaPremierPremiumBloc extends BaseBloc{
  ...
  Future<ArogyaPremierPremiumResModel> calculatePremium(ArogyaPremierPremiumReqModel reqModel, bool isFamilyFloaterOrFamilyIndividual) async{
    Map<String, dynamic> body = reqModel.toJson();
    var response = await ArogyaPremierPremiumApiProvider.getInstance().calculatePremium(body, isFamilyFloaterOrFamilyIndividual);
