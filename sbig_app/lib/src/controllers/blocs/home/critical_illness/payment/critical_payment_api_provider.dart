...
class CriticalIllnessPaymentApiProvider extends ApiResponseListenerDio {

  Future<ParsedResponse<InsurancePaymentResModel>> criticalIllnessPaymentStatusCheckApiCall(InsurancePayment request) async {
    return BaseApiProvider.postApiCall(UrlConstants.PAYMENT_PROCESS_CRITICAL_ILLNESS_URL, request.toJson()).then((response) {
      try {
